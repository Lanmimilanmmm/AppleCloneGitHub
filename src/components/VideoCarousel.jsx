...
const VideoCarousel = () => {
    ...
    const {isEnd, isLastVideo, starPlay, videoId, isPlaying } = video;
    ...
    useEffect(()=>{
        if(loadedData.length >3 ){
            if(!isPlaying){
                ...
                starPlay && videoRef.current[videoId].play()
            }
        }
    }, [starPlay, videoId, isPlaying, loadedData])
